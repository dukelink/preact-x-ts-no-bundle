...
} var s = e.namespace || "MyDropdown"; return L || (L = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.Y || 1 === r.Y && !t.J.Z) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    if ("style" === e) {
        ...
        if ("list" !== e && "type" !== e && !o && (e in t || -1 !== ["object", "function"].indexOf(typeof i) && null !== i)) {
            var f = n.tn(t);
            f && f.en && f.en[e] ? m(t, e, i) : "ref" !== e && (m(t, e, null == i ? "" : i), null != i && !1 !== i || n.J.rn(t, e));
        }
        else
    ...
    case 0: return n.mn.delete(r), n.gn.has(r) ? [3, 12] : (a = n.Mn.get(r)) ? [3, 6] : (s = n.kn.get(r)) && !s["s-rn"] ? ((s["s-rc"] = s["s-rc"] || []).push(function () { O(n, r, f); }), [2]) : (a = W(n, r, n.$n.get(r), f), [3, 5]);
    case 1: return o.M.push([1, 4, , 5]), a.componentWillLoad ? [4, a.componentWillLoad()] : [3, 3];
    case 2: o.k(), o.label = 3;
    case 3: return [3, 5];
    case 4: return i = o.k(), n.jn(i, 3, r), [3, 5];
    case 5:
    case 6: return [3, 11];
    case 7: return o.M.push([7, 10, , 11]), a.componentWillUpdate ? [4, a.componentWillUpdate()] : [3, 9];
    case 8: o.k(), o.label = 9;
    case 9: return [3, 11];
    case 10: return u = o.k(), n.jn(u, 5, r), [3, 11];
    ...
    case 12: return [2];
} }); }); }, _ = function (n, t, e, r, i, o, u) { (u = n._n.get(t)) || n._n.set(t, u = {}), r !== u[e] && (u[e] = r, n.Mn.get(t) && !n.Sn && t["s-rn"] && S(n, t, i)); }, T = function (n, t, e, r) { Object.defineProperty(n, t, { configurable: !0, get: e, set: r }); }, W = function (n, t, e, r, i, o) { try {
...
} return !0; }, P = function (n, t, e, r, i, o) { if (n.wn.delete(t), (i = n.kn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.kn.delete(t)), n.Nn.length && !n.wn.size)
    for (; o = n.Nn.shift();)
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Rn = !0; } }));
...
catch (n) { } return i; }(d, r, i), y = h.K.documentElement, w = r["s-defined"] = r["s-defined"] || {}, m = { J: h, u: function (n, t) { r.customElements.get(n.t) || (function (n, t, e, r, i) { if (e.connectedCallback = function () { (function (n, t, e) { n.gn.delete(e), n.Pn.has(e) || (n.it = !0, n.wn.add(e), n.Pn.set(e, !0), function (n, t, e) { for (e = t; e = n.J.nt(e);)
        if (n.ot(e)) {
            n.ut.has(t) || (n.kn.set(t, e), (e["s-ld"] = e["s-ld"] || []).push(t));
            break;
        } }(n, e), n.queue.tick(function () { n.$n.set(e, function (n, t, e, r, i) { if (e.mode || (e.mode = n.Vn(e)), e["s-cr"] || n.Jn(e, "ssrv") || n.Z && 1 === t.Y || (e["s-cr"] = n.Fn(""), e["s-cr"]["s-cn"] = !0, n.nn(e, e["s-cr"], n.Bn(e)[0])), !n.Z && 1 === t.Y)
        try {
            !window.HTMLElement || "shadowRoot" in window.HTMLElement.prototype || (e.shadowRoot = e);
        }
        catch (n) { } return 1 === t.Y && n.Z && !e.shadowRoot && n.rt(e, { mode: "open" }), r = { Wn: {} }, t.en && Object.keys(t.en).forEach(function (o) { (i = t.en[o].fn) && (r.Wn[i] = n.Jn(e, i)); }), r; }(n.J, t, e)), n.ft(t, e); })); })(n, t, this); }, e.disconnectedCallback = function () { (function (n, t) { !n.ct && function (n, t) { for (; t;) {
        if (!n.In(t))
            return 9 !== n.Ln(t);
        t = n.In(t);
    } }(n.J, t) && (n.gn.set(t, !0), P(n, t), M(n.On.get(t), !0), n.J.un(t), n.at.delete(t), n.l && n.l.removeHost(t), [n.kn, n.st, n.$n].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (x(n, t) && n.Mn.get(t) && !n.gn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ut.set(t, !0), n.lt.has(t) || (n.lt.set(t, !0), t["s-ld"] = void 0, n.J.Cn(t, e));
        try {
            M(n.On.get(t)), (o = n.st.get(t)) && (o.forEach(function (n) { return n(t); }), n.st.delete(t));
        }
        catch (e) {
            n.jn(e, 4, t);
        }
        ...
        (function (n, t, e, r) { o.forEach(function (t) { var i = t[0], o = t[1]; 3 & o.cn && T(e, i, function t() { return (n._n.get(this) || {})[i]; }, function t(e) { _(n, this, i, C(o.sn, e), r); }); }); })(n, 0, e, i);
    } }(m, a[n.t] = n, t.prototype, u, f), r.customElements.define(n.t, t)); }, tn: function (n) { return a[h.Yn(n)]; }, vt: function (n) { return t[n]; }, isClient: !0, ot: function (n) { return !(!w[h.Yn(n)] && !m.tn(n)); }, jn: function (n, t, e) { return console.error(n, t, e && e.tagName); }, queue: t.queue = k(d, r), ft: function (n, t) { var e = !h.Z, r = { mode: t.mode, scoped: e }; n.s(r).then(function (e) { try {
    ...
    } S(m, t, f); }); }, Sn: !1, bn: !1, ct: !1, En: l, kn: new WeakMap, V: new WeakMap, Pn: new WeakMap, at: new WeakMap, lt: new WeakMap, ut: new WeakMap, Tn: new WeakMap, $n: new WeakMap, Mn: new WeakMap, gn: new WeakMap, mn: new WeakMap, st: new WeakMap, pt: new WeakMap, On: new WeakMap, _n: new WeakMap, wn: new Set, Nn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, m.xn = t.emit = function (n, e, r) { return h.tt(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return m.queue.write(function () { return m.wn.size ? m.Nn.push(n) : n(); }); }); }, m.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, m, M) { if (m = l.vchildren[p], e || (o = !0, "slot" === m.vtag && (r && t.Cn(d, r + "-s"), m.vchildren ? m.dt = !0 : m.ht = !0)), v(m.vtext))
    m.i = t.Fn(m.vtext);
else if (m.ht)
    m.i = t.Fn("");
else {
    if (y = m.i = g || "svg" === m.vtag ? t.Dn("http://www.w3.org/2000/svg", m.vtag) : t.X(m.dt ? "slot-fb" : m.vtag), n.ot(y) && n.ut.delete(c), g = "svg" === m.vtag || "foreignObject" !== m.vtag && g, b(n, null, m, g), v(r) && y["s-si"] !== r && t.Cn(y, y["s-si"] = r), m.vchildren)
        for (h = 0; h < m.vchildren.length; ++h)
            (w = a(i, m, h, y)) && t.Un(y, w);
    "svg" === m.vtag && (g = !1);
} return m.i["s-hn"] = f, (m.dt || m.ht) && (m.i["s-sr"] = !0, m.i["s-cr"] = u, m.i["s-sn"] = m.vname || "", (M = i && i.vchildren && i.vchildren[p]) && M.vtag === m.vtag && i.i && s(i.i)), m.i; }, s = function (e, r, i, u) { n.ct = !0; var c = t.Bn(e); for (i = c.length - 1; i >= 0; i--)
    (u = c[i])["s-hn"] !== f && u["s-ol"] && (t.qn(u), t.nn(y(u), u, h(u)), t.qn(u["s-ol"]), u["s-ol"] = null, o = !0), r && s(u, r); n.ct = !1; }, l = function (n, e, r, i, o, u, c, s) { var l = n["s-cr"]; for ((c = l && t.In(l) || n).shadowRoot && t.Yn(c) === f && (c = c.shadowRoot); o <= u; ++o)
    i[o] && (s = v(i[o].vtext) ? t.Fn(i[o].vtext) : a(null, r, o, n)) && (i[o].i = s, t.nn(c, s, h(e))); }, p = function (n, e, r, o) { for (; e <= r; ++e)
    v(n[e]) && (o = n[e].i, i = !0, o["s-ol"] ? t.qn(o["s-ol"]) : s(o, !0), t.qn(o)); }, d = function (n, t) { return n.vtag === t.vtag && n.vkey === t.vkey && ("slot" !== n.vtag || n.vname === t.vname); }, h = function (n) { return n && n["s-ol"] ? n["s-ol"] : n; }, y = function (n) { return t.In(n["s-ol"] ? n["s-ol"] : n); }, w = function (e, r, i) { var o = r.i = e.i, u = e.vchildren, f = r.vchildren; g = r.i && v(t.nt(r.i)) && void 0 !== r.i.ownerSVGElement, g = "svg" === r.vtag || "foreignObject" !== r.vtag && g, v(r.vtext) ? (i = o["s-cr"]) ? t.zn(t.In(i), r.vtext) : e.vtext !== r.vtext && t.zn(o, r.vtext) : ("slot" !== r.vtag && b(n, e, r, g), v(u) && v(f) ? function (n, e, r, i, o, u, f, c) { for (var m = 0, b = 0, g = e.length - 1, M = e[0], k = e[g], $ = i.length - 1, j = i[0], A = i[$]; m <= g && b <= $;)
    if (null == M)
        M = e[++m];
    else if (null == k)
        k = e[--g];
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.In(M.i)), w(M, A), t.nn(n, M.i, t.Gn(k.i)), M = e[++m], A = i[--$];
    else if (d(k, j))
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.In(k.i)), w(k, j), t.nn(n, k.i, M.i), k = e[--g], j = i[++b];
    else {
        ...
        v(o) ? ((c = e[o]).vtag !== j.vtag ? f = a(e && e[b], r, o, n) : (w(c, j), e[o] = void 0, f = c.i), j = i[++b]) : (f = a(e && e[b], r, b, n), j = i[++b]), f && t.nn(y(M.i), f, h(M.i));
    } m > g ? l(n, null == i[$ + 1] ? null : i[$ + 1].i, r, i, b, $) : b > $ && p(e, m, g); }(o, u, r, f) : v(f) ? (v(e.vtext) && t.zn(o, ""), l(o, null, r, f, 0, f.length - 1)) : v(u) && p(u, 0, u.length - 1)), g && "svg" === r.vtag && (g = !1); }, m = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.Bn(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Ln(e)) {
        if (e["s-sr"])
        ...
        m(e);
    } }, M = [], k = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.Bn(n)).length; u < f; u++) {
    if ((r = e[u])["s-sr"] && (o = r["s-cr"]))
        for (a = t.Bn(t.In(o)), s = r["s-sn"], c = a.length - 1; c >= 0; c--)
            (o = a[c])["s-cn"] || o["s-nr"] || o["s-hn"] === r["s-hn"] || ((3 === (l = t.Ln(o)) || 8 === l) && "" === s || 1 === l && null === t.Jn(o, "slot") && "" === s || 1 === l && t.Jn(o, "slot") === s) && (M.some(function (n) { return n.yt === o; }) || (i = !0, o["s-sn"] = s, M.push({ wt: r, yt: o })));
    1 === t.Ln(r) && k(r);
} }; return function (a, s, l, v, p, d, h, y, b, g, $, j) { if (c = a, f = t.Yn(c), u = c["s-cr"], e = v, r = c["s-sc"], o = i = !1, w(s, l), o) {
    for (k(l.i), h = 0; h < M.length; h++)
        (y = M[h]).yt["s-ol"] || ((b = t.Fn(""))["s-nr"] = y.yt, t.nn(t.In(y.yt), y.yt["s-ol"] = b, y.yt));
    for (n.ct = !0, h = 0; h < M.length; h++) {
        for (y = M[h], $ = t.In(y.wt), j = t.Gn(y.wt), b = y.yt["s-ol"]; b = t.Qn(b);)
            if ((g = b["s-nr"]) && g && g["s-sn"] === y.yt["s-sn"] && $ === t.In(g) && (g = t.Gn(g)) && g && !g["s-nr"]) {
                j = g;
                break;
            }
        (!j && $ !== t.In(y.yt) || t.Gn(y.yt) !== j) && y.yt !== j && (t.qn(y.yt), t.nn($, y.yt, j));
    }
    n.ct = !1;
} return i && m(l.i), M.length = 0, l; }; }(m, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { m.ut.set(y, d.loaded = m.bn = !0), h.tt(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(m, d, r, r["s-apps"], r["s-cr"]), d.initialized = !0, m; }, R = {}, L = !1;
